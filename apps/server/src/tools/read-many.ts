...
export const readManyTool: ToolPlugin = {
  register(server, context) {
    server.registerTool("read_many", {
      description: `Efficiently read one or more files or line ranges in one call; prefer this over repeated Codex fs/readFile calls. Relative paths resolve from the RCE project root. Text uses 1-indexed offset/limit and truncates at ${DEFAULT_MAX_LINES} lines or ${DEFAULT_MAX_BYTES / 1024}KB. Supports png, jpeg, gif, and webp images as attachments.`,
